...
# 导入测试器
from bat_totem_test_001 import BatTotemTester


class BatTotemTestRunner:
    """蝙蝠图腾测试运行器"""
    ...
    def __init__(self, http_port=8080):
        ...
        self.log_file = log_dir / f"ai_client_bat_totem_{timestamp}.log"
    ...
    async def run_test(self):
        """运行测试"""
        self.log("=" * 60, "SYSTEM")
        self.log("启动BAT-TOTEM-001测试", "SYSTEM")
        self.log("=" * 60, "SYSTEM")
        ...
        try:
            # 运行测试
            async with BatTotemTester(self.http_port) as tester:
...
async def main():
    ...
    runner = BatTotemTestRunner(http_port)
