...
# 导入测试器
from cow_totem_test_001 import CowTotemTester


class CowTotemTestRunner:
    """牛图腾测试运行器"""
    ...
    def __init__(self, http_port=8080):
        ...
        self.log_file = log_dir / f"ai_client_cow_totem_{timestamp}.log"
    ...
    async def run_test(self):
        """运行测试"""
        self.log("=" * 60, "SYSTEM")
        self.log("启动COW-TOTEM-001测试", "SYSTEM")
        self.log("=" * 60, "SYSTEM")
        ...
        try:
            # 运行测试
            async with CowTotemTester(self.http_port) as tester:
...
async def main():
    ...
    runner = CowTotemTestRunner(http_port)
