#!/usr/bin/env python3
"""
蝴蝶图腾流派测试脚本 (TOTEM-BUTTERFLY-001) - 简化版
"""
...
class ButterflyTester:
    ...
    async def __aenter__(self):
        ...
        self.log_file = Path(f"logs/ai_session_butterfly_totem_{timestamp}.log")
    ...
    async def run_test(self):
        self.log("=" * 60, "SYSTEM")
        self.log("开始蝴蝶图腾流派测试 (TOTEM-BUTTERFLY-001)", "SYSTEM")
        self.log("=" * 60, "SYSTEM")
        ...
        # 选择蝴蝶图腾
        self.log("选择蝴蝶图腾...", "ACTION")
        await self.send_actions([{"type": "select_totem", "totem_id": "butterfly_totem"}])
        ...
        for o in obs:
            if "法球" in o or "orb" in o.lower():
                self.log("✅ 发现法球机制日志", "VALIDATION")
            if "法力" in o or "mana" in o.lower():
                self.log("✅ 发现法力机制日志", "VALIDATION")
...
async def main():
    ...
    async with ButterflyTester(http_port) as tester:
