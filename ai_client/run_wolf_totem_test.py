...
# 导入测试器
from wolf_totem_test_001 import WolfTotemTester


class WolfTotemTestRunner:
    """狼图腾测试运行器"""
    ...
    def __init__(self, http_port=8080):
        ...
        self.log_file = log_dir / f"ai_client_wolf_totem_{timestamp}.log"
    ...
    async def run_test(self):
        """运行测试"""
        self.log("=" * 60, "SYSTEM")
        self.log("启动WOLF-TOTEM-001测试", "SYSTEM")
        self.log("=" * 60, "SYSTEM")
        ...
        try:
            # 运行测试
            async with WolfTotemTester(self.http_port) as tester:
...
async def main():
    ...
    runner = WolfTotemTestRunner(http_port)
